...
st.markdown("<style>html{overflow-y:scroll;}.block-container{max-width:1180px;margin:0 auto;padding-top:2.2rem;padding-left:3rem;padding-right:3rem;}</style><style>iframe[height='0']{display:none;}</style>", unsafe_allow_html=True)
